...
def test_parse_detail_extracts_title_from_h1():
...
def test_parse_detail_falls_back_to_seed_title_when_page_has_none():
...
def test_parse_detail_extracts_body_from_main_paragraphs():
    seed = {"id": "MOC-000003", "title": "T", "body": ""}
    html = "<main><p>第一段。</p><p>第二段。</p></main>"
    spider = AnimateSpider.__new__(AnimateSpider)
    response = _fake_response("https://children.moc.gov.tw/book/3", html)
    result = list(spider.parse_detail(response, seed=seed))
